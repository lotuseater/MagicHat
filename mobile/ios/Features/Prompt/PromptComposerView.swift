...
public struct PromptComposerView: View {
    ...
    public var body: some View {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    TextEditor(text: $promptText)
                        ...
                        .accessibilityIdentifier("magichat.prompts.promptText")
                    ...
                    .accessibilityIdentifier("magichat.prompts.sendPrompt")
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    TextEditor(text: $followUpText)
                        ...
                        .padding(8)
                        .background(.thinMaterial, in: RoundedRectangle(cornerRadius: 10, style: .continuous))
                        .accessibilityIdentifier("magichat.prompts.followUpText")
                    ...
                    .accessibilityIdentifier("magichat.prompts.sendFollowUp")
        ...
        .accessibilityIdentifier("magichat.prompts.screen")
    }
}
